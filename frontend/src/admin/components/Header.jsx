                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <Link to="/admin" className="flex items-center ms-2">
                                ...
                                <span className="text-xl font-semibold whitespace-nowrap">NEWSPORTAL</span>
                            </Link>
                        </div>
                        <div className="flex items-center">
            ...
            >
                <div className="h-full px-3 pb-4 overflow-y-auto bg-white">
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <Link to="/admin/news" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100">
                                📰 <span className="ms-3">News</span>
                            </Link>
                        </li>
                        <li>
                            <Link to="/admin/category" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100">
